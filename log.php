...
.particle:nth-child(4) { width: 12px; height: 12px; left: 50%; animation-delay: 1s; }
.particle:nth-child(5) { width: 10px; height: 10px; left: 70%; animation-delay: 3s; }
.particle:nth-child(6) { width: 14px; height: 14px; left: 80%; animation-delay: 5s; }
.particle:nth-child(7) { width: 9px; height: 9px; left: 90%; animation-delay: 2.5s; }

@keyframes rise {
    0% { bottom: -50px; opacity: 0; transform: translateX(0); }
    10% { opacity: 1; }
    90% { opacity: 1; }
    100% { bottom: 110vh; opacity: 0; transform: translateX(100px); }
}
...
.social-btn.google { color: #18c40cff; }
.social-btn.phone { color: #1c1d1eff; }
